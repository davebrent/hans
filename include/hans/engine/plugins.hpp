#ifndef HANS_ENGINE_PLUGINS_H_
#define HANS_ENGINE_PLUGINS_H_
...
class PluginManager {
 public:
  ...
  PluginManager(StringManager& strings);
  PluginManager(StringManager& strings, const Plugins& plugins);
  ~PluginManager();
